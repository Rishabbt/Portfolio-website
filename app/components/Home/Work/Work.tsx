...
const projects = [
  {
    ...
    title: "Project1-",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum velit illum libero? Debitis fugiat odit voluptatibus optio facilis temporibus nulla minus nihil magni modi pariatur, aliquam placeat! Commodi, eos cumque",
...
const Work = () => {
  ...
  return (
    <motion.section
      ...
      className="mx-5 min-h-[80vh] flex flex-col justify-center py-12 xl:px-0"
    >
