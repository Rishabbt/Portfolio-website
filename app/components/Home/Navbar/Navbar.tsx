    ...
    <div className= {`transition-all ${navBg ? "bg-[#0f142ed9] shadow-md " : "fixed "} duration-200 h-[12vh] z-[10000] fixed w-full`} >
        <div className='flex items-center h-full justify-between w-[90%] mx-auto'>
            ...
            <div className='flex items-centre space-x-4'>
                {/* <button className='px-8 py-3.5 text-sm cursor-pointer rounded-lg bg-blue-700 hover:bg-blue-900 transition-all duration-300 text-white flex item-center space-x-2'>
